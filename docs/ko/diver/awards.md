...
**My Library** 페이지에서는 내 인정 카드(awards)를 확인하고, (계정에서 가능할 경우) 주문할 수 있습니다.

## 어디에서 찾을 수 있나요

메뉴: **다이버 -> My Library**

![My Library](../../assets/screenshots/diver/en/awards.png)
...
주문이 성공하면 카드가 발급되며, **My Library**에서 확인할 수 있습니다.
